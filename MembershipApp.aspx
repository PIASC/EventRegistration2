<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MembershipApp.aspx.cs" Inherits="LouACH.MembershipApp" %>
...
<div class="gridContainer clearfix">
    ...
    <div id="main" class="fluid ">
        <div id="centered">
            <div class="fluid" >
                    <div class="box2">
                        <p><label for="txtAmount">Amount Due:</label><input class="TxtArea" name="txtAmount" id="txtAmount" ="10" value=" "/><br/><br/>
                        <label for="txtCoName">&nbsp;&nbsp;&nbsp;&nbsp;Name:</label><input class="TxtArea" name="txtFName" value=" " style="width:220px" placeholder="First Name"/><input class="TxtArea" name="txtLName" value=" " style="width:220px"  placeholder="Last Name"/><br/>
